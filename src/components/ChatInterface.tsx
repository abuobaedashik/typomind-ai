...
const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-white max-w-[1980px] rounded-lg shadow-lg">
      {/* Header */}
      <div className="flex items-center p-4 space-x-3 text-[#131313]">
        <div className="p-2 rounded-full">
          <img
            src={bot}
            alt="bot"
            className="object-cover w-12 h-12 p-1 border border-[#121212] rounded-full"
          />
        </div>
        <div>
